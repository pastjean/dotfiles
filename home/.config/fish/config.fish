...
# config.fish lives at <repo>/home/.config/fish, so repo root is 3 levels up
set DOTFILES (dirname (dirname (dirname $FISH_TOPIC_DIR)))
...
# Lucid Memory
set -gx PATH $HOME/.lucid/bin $PATH
